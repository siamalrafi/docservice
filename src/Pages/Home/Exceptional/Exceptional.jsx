...
const Exceptional = () => {
    return (
        <div>
            ...
            <div className='grid lg:grid-cols-2 md:grid-cols-2 sm:grid-cols-1 justify-items-center py-10 px-5'>

                <figure className="lg:pl-10 md:pl-10 border-2 rounded border-indigo-500">
                    <img src={exceptional} alt="Shoes" className="rounded-xl" />
                </figure>

                <div>
                    <h1 className='text-2xl text-justify'> Exceptional Service Care, on Your Terms</h1>
